...
import { StyledThemeMainDiv , StyledlightModeDiv , StyledDarkModeDiv } from "./Header.styled";
...
<StyledThemeMainDiv>
            < StyledlightModeDiv
                className={"lightMode " + (themeContext.theme === "light" ? "unvisible" : "")}
                onClick={ligthOnClick}>
            </StyledlightModeDiv>

            <StyledDarkModeDiv
                className={"darkMode " + (themeContext.theme === "dark" ? "unvisible" : "")} 
                onClick={darkOnClick} > 
            </StyledDarkModeDiv>
        </StyledThemeMainDiv>
